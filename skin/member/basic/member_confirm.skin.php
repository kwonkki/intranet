    ...
    <td width="628" align="center" background="<?=$member_skin_path?>/img/modify_table_bg.gif">
        ...
        <tr> 
            <td width="460" height="223" align="center" bgcolor="#FFFFFF">
                ...
                <tr> 
                    <td width="250">
                        ...
                        <tr> 
                            ...
                            <td width="90" height="26"><b>member ID</b></td>
                            <td width="150"><b><?=$member[mb_id]?></b></td>
                        </tr>
                        <tr> 
                            <td><img src="<?=$member_skin_path?>/img/icon.gif" width="3" height="3"></td>
                            <td height="26"><b>password</b></td>
                            <td><INPUT type=password maxLength=20 size=15 name="mb_password" id="confirm_mb_password" itemname="password" required onkeypress="check_capslock('confirm_mb_password');"></td>
                        </tr>
                        </table>
                    </td>
                ...
                <table>
                <tr align="center"> 
                    <td height="80" colspan="2">Please log-in</td>
                </tr>
                </table></td>
        </tr>
        </table></td>
