    ...
    <td width="628" align="center" background="<?=$member_skin_path?>/img/login_table_bg.gif">
        ...
        <tr>
            <td width="460" height="223" align="center" bgcolor="#FFFFFF">
                ...
                <tr>
                    <td width="250">
                        ...
                        <tr>
                            <td><img src="<?=$member_skin_path?>/img/icon.gif" width="3" height="3"></td>
                            <td height="26"><b></b></td>
                            <td><INPUT onclick="if (this.checked) { if (confirm('Do you want to use the auto-login?')) { this.checked = true; } else { this.checked = false;} }" type=checkbox name=auto_login>
                                <b>AUTO-LOGIN</b></td>
                        </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td height="26" colspan="2"><img src="<?=$member_skin_path?>/img/icon.gif" width="3" height="3"> REGISTER&nbsp;&nbsp;&nbsp;&nbsp;<a href="./register.php"><img width="72" height="20" src="<?=$member_skin_path?>/img/btn_register.gif" border=0 align="absmiddle"></a></td>
                </tr>
                <tr>
                    ...
                    <td height="26" colspan="2"><img src="<?=$member_skin_path?>/img/icon.gif" width="3" height="3"> FIND ID/PW &nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:;" onclick="win_password_lost();"><img src="<?=$member_skin_path?>/img/btn_password_forget.gif" width="108" height="20" border=0 align="absmiddle"></td>
                </tr>
                </table></td>
        </tr>
        </table></td>
