...
<div style="width:220px;">
    ...
    <div style="width:210px; float:left; margin-top:10px;">
        ...
        <tr>
            <td width="141">
                ...
                <tr>
                    ...
                    <td width="106" height="23" colspan="2" align="center"><input name="mb_id" type="text" class=ed size="12" maxlength="20" required itemname="mb_id" value='mb_id' onMouseOver='chkReset(this.form);' onFocus='chkReset(this.form);'></td>
                </tr>
                <tr>
                    <td width="35" height="23"><img src="<?=$outlogin_skin_path?>/img/login_pw.gif" width="35" height="23"></td>
                    <td id=pw1 width="106" height="23" colspan="2" align="center"><input type="text" class=ed size="12" maxlength="20" required itemname="password" value='password' onMouseOver='chkReset(this.form);' onfocus='chkReset(this.form);'></td>
        ...
        <div style="clear:both; padding:2px 0 0 42px;">
            <div style="float:left;"><input type="checkbox" name="auto_login" value="1" onclick="if (this.checked) { if (confirm('Do you want to setup the auto login?')) { this.checked = true; } else { this.checked = false; } }"></div>
