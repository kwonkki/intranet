...
<tr height="25">
    ...
    <td align="right" style="font:normal 11px tahoma; color:#BABABA;">
        ...
        <? if ($admin_href) { ?><a href="<?=$admin_href?>"><img src="<?=$board_skin_path?>/img/btn_admin.gif" title="admin" width="63" height="22" border="0" align="absmiddle"></a><?}?></td>
</tr>
...
<tr height=28 align=center>
    ...
    <? if ($is_nogood) { ?><td width=40><?=subject_sort_link('wr_nogood', $qstr2, 1)?>Nogood</a></td><?}?>
</tr>
...
<? if (count($list) == 0) { echo "<tr><td colspan='$colspan' height=100 align=center>No writing found</td></tr>"; } ?>
