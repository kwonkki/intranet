...
<tr><td height=30>&nbsp;&nbsp;<font style="font:normal 11px 돋움; color:#BABABA;">Poster :</font> <?=$view[name]?><? if ($is_ip_view) { echo "&nbsp;($ip)"; } ?>&nbsp;&nbsp;&nbsp;&nbsp;
    <font style="font:normal 11px 돋움; color:#BABABA;">Date :</font><font style="font:normal 11px tahoma; color:#BABABA;"> <?=substr($view[wr_datetime],2,14)?>&nbsp;&nbsp;&nbsp;&nbsp;</font>
    <font style="font:normal 11px 돋움; color:#BABABA;">Hit :</font><font style="font:normal 11px tahoma; color:#BABABA;"> <?=$view[wr_hit]?>&nbsp;&nbsp;&nbsp;&nbsp;</font>
    <? if ($is_good) { ?><font style="font:normal 11px 돋움; color:#BABABA;">Good</font> :<font style="font:normal 11px tahoma; color:#BABABA;"> <?=$view[wr_good]?>&nbsp;&nbsp;&nbsp;&nbsp;<?}?></font>
    <? if ($is_nogood) { ?><font style="font:normal 11px 돋움; color:#BABABA;">Nogood</font> :<font style="font:normal 11px tahoma; color:#BABABA;"> <?=$view[wr_nogood]?>&nbsp;&nbsp;&nbsp;&nbsp;<?}?></font>
    <? if ($trackback_url) { ?><a href="javascript:trackback_send_server('<?=$trackback_url?>');" style="letter-spacing:0;" title='주소 복사'><img src="<?=$board_skin_path?>/img/icon_trackback.gif" alt="" align="absmiddle" border=0></a><?}?>
    </td>
</tr>
...
function file_download(link, file) {
    <? if ($board[bo_download_point] < 0) { ?>if (confirm("<?=number_format($board[bo_download_point])?> points will be deducted by downloading '"+file+"' for once.\n\nContinue?"))<?}?>
