...
<table width="100%" cellspacing="0" cellpadding="0">
	<tbody>
		<tr height="25">
			<td>
			<img src="<?=$g4[path]?>/images/greetings.png">	
			</td>
		</tr>
		<tr>
			<td height="5"></td>
        ...
        <?
		    ...
		    ?>
	          &nbsp;<a href="<?=$write_href?>&w=u&wr_id=<?=$list[$i][wr_id]?>&page=<?=$page?>&sca=<?=$ca_name?>">
  	  			<img src="<?=$board_skin_path1?>/img/btn_edit.gif" alt="수정" border="0" align="absmiddle" title="edit"></a>
	          <a href="javascript:if (confirm('Do you want to delete?')) { location='./delete.php?w=d&bo_table=<?=$bo_table?>&wr_id=<?=$list[$i][wr_id]?>&sca=<?=$sca?>';}">
				    <img src="<?=$board_skin_path1?>/img/btn_delete.gif" alt="삭제" border="0" align="absmiddle" title="delete"></a>
        <?
        }
