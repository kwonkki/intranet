...
.field { padding:.5em; border-bottom:1px solid #E7E7E7; }
</style>
...
<table border=0 cellpadding=0 cellspacing=0 width=100%>
	...
	<tr>
	<td class="view_head">기획자</td><td class="view_tail"><?=$view[name]?></td>
	<td class="view_head">디자이너</td><td class="view_tail"><?=$view[wr_2]?></td>
	<td class="view_head">프로그래머</td><td class="view_tail"><?=$view[wr_3]?></td>
	</tr>
</table>
...
<tr>
	<td class="view_head">진행상태</td>
	<td class="field">&nbsp;<?php
    if($view[wr_5]=="접수") echo "<img src='$board_skin_path/img/order1.gif' align='absmiddle' border='0'>";
	elseif($view[wr_5]=="진행중") echo "<img src='$board_skin_path/img/order2.gif' align='absmiddle' border='0'>";
	elseif($view[wr_5]=="보류") echo "<img src='$board_skin_path/img/order3.gif' align='absmiddle' border='0'>";
	elseif($view[wr_5]=="완료") echo "<img src='$board_skin_path/img/order4.gif' align='absmiddle' border='0'>";
	else echo "<img src='$board_skin_path/img/order1.gif' align='absmiddle' border='0'>";
	?>
	</td>
	<td class="view_head">완료예정일</td><td class="view_tail"><?=$view[wr_4]?></td>
	<td class="view_head">진행률</td><td class="view_tail"><?=$view[wr_6]?>%</td>
</tr>
...
<div style="height:3px; line-height:1px; font-size:1px; background-color:<?=$board_color[0]?>; clear:both;">&nbsp;</div>
