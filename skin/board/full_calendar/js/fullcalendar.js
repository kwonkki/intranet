...
var defaults = {
	...
	dayNames: ['sun','mon','tue','wed','thu','fri','sun'],
	dayNamesShort: ['sun','mon','tue','wed','thu','fri','sun'],
	buttonText: {
		prev: '&nbsp;◀&nbsp;',
		next: '&nbsp;▶&nbsp;',
		//prev: '<img src=../g/img/btn_prev_c.gif>',
		//next: '<img src=../g/img/btn_next_c.gif>',
		prevYear: '&nbsp;&lt;&lt;&nbsp;',
		nextYear: '&nbsp;&gt;&gt;&nbsp;',
		today: '&nbsp;today&nbsp;',
		//today: '<img src=../g/img/btn_today.gif>',
		month: '&nbsp;&nbsp; Mon &nbsp;&nbsp;',
		week: '&nbsp;&nbsp; week &nbsp;&nbsp;',
		day: '&nbsp;&nbsp; day &nbsp;&nbsp;'
	},
				...
				$.each(buttonStr.split(' '), function(i) {
					...
					$.each(this.split(','), function(j, buttonName) {
						if (buttonName == 'title') {
							...
							if (buttonClick) {
								if (prevButton) {
									prevButton.addClass(tm + '-no-left');
								}
								var button,
		...
		if (!tbody) { // first time, build all cells from scratch
			...
			for (i=0; i<colCnt; i++) {
				s += "<th class='fc-" +
					...
					//"'><img src='../z_img/week_" + dayIDs[d.getDay()] + ".gif'></th>";
					"' style='font-size:11px; font-weight:normal;'>" + dayIDs[d.getDay()] + "</th>";
				addDays(d, 1);
				if (nwe) {
					skipWeekend(d);
				}
