...
<table border=0 cellpadding=0 cellspacing=0 width=100% class="latest_head_basic">
<tr height=30>
<td class="top">
	<ul>
	<? if($tab_cnt > 1) { ?>
...
<tr><td class="bottom">
	<img src="<?=$latest_skin_path?>/img/hd_bottom_white.gif" style="display:block;" border=0>
</td></tr>
<? if($opt[head_gap] != 1) { ?>
