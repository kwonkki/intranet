...
<tr>
    <td height=30 background="<?=$board_skin_path?>/img/view_dot.gif" style="color:#888;">
        ...
        &nbsp;작성자 : 
        <?=$view[name]?><span style="font-size:8pt; color:#D2D2D2;"><? if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></span> <!---<a href="<?=$view[wr_homepage]?>" target="_blank"><img src='<?=$board_skin_path?>/img/home.gif' border='0' align='absmiddle'></a>--->
        </div>
        <div style="float:right;">Date : <span style=font-size:8pt;><?=date("Y-m-d H:i", strtotime($view[wr_datetime]))?>&nbsp;&nbsp;|&nbsp;&nbsp;Hit : <?=number_format($view[wr_hit])?></span>
