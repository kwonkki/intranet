...
<table border=0 cellpadding=0 cellspacing=0 width=100%>
	...
	<tr>
	<td width="15%" class="view_head">기획자</td><td width="15%" class="view_tail">&nbsp;<?=$view[name]?></td>
	<td width="15%" class="view_head">디자이너</td><td width="15%" class="view_tail">&nbsp;<?=$view[wr_2]?></td>
	<td width="15%" class="view_head">프로그래머</td><td width="13%" class="view_tail">&nbsp;<?=$view[wr_3]?></td>
	</tr>
</table>
...
<tr>
	<td width="15%" class="view_head">진행상태</td>
	...
	<td width="15%" class="view_head">완료예정일</td><td width="15%" class="view_tail">&nbsp;<?=$view[wr_4]?></td>
	<td width="15%" class="view_head">진행률</td><td width="13%" class="view_tail">&nbsp;<?=$view[wr_6]?>%</td>
</tr>
