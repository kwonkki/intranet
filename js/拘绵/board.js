...
if (borderColor) $(this).css({ "border" : "1px solid "+ borderColor }); if (!imageWindow) { $(this).bind("contextmenu",function(e){ alert("in the picture, you cant mouse right click."); return false;})
